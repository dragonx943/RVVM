...
#if defined(USE_JIT) && (!defined(RISCV64) || defined(RVJIT_NATIVE_64BIT))
...
#if defined(RVJIT_NATIVE_BITMANIP)
...
// RV64 Zba
#define rvjit_trace_shadd(rds, rs1, rs2, shift, size)                                                                  \
    RVVM_RVJIT_TRACE_BITMANIP(rvjit64_shadd(&vm->jit, rds, rs1, rs2, shift), size)
#define rvjit_trace_shadd_uw(rds, rs1, rs2, shift, size)                                                               \
    RVVM_RVJIT_TRACE_BITMANIP(rvjit64_shadd_uw(&vm->jit, rds, rs1, rs2, shift), size)
#define rvjit_trace_slli_uw(rds, rs1, imm, size)                                                                       \
    RVVM_RVJIT_TRACE_BITMANIP(rvjit64_slli_uw(&vm->jit, rds, rs1, imm), size)
...
// RV32 Zba
#define rvjit_trace_shadd(rds, rs1, rs2, shift, size)                                                                  \
    RVVM_RVJIT_TRACE_BITMANIP(rvjit32_shadd(&vm->jit, rds, rs1, rs2, shift), size)
...
#define rvjit_trace_fmadd_s(rds, rs1, rs2, rs3, size)                                                                  \
    RVVM_RVJIT_TRACE_FPU(rvjit_fmadd_s(&vm->jit, rds, rs1, rs2, rs3), size)
#define rvjit_trace_fmadd_d(rds, rs1, rs2, rs3, size)                                                                  \
    RVVM_RVJIT_TRACE_FPU(rvjit_fmadd_d(&vm->jit, rds, rs1, rs2, rs3), size)
#define rvjit_trace_fmsub_s(rds, rs1, rs2, rs3, size)                                                                  \
    RVVM_RVJIT_TRACE_FPU(rvjit_fmsub_s(&vm->jit, rds, rs1, rs2, rs3), size)
#define rvjit_trace_fmsub_d(rds, rs1, rs2, rs3, size)                                                                  \
    RVVM_RVJIT_TRACE_FPU(rvjit_fmsub_d(&vm->jit, rds, rs1, rs2, rs3), size)
#define rvjit_trace_fnmadd_s(rds, rs1, rs2, rs3, size)                                                                 \
    RVVM_RVJIT_TRACE_FPU(rvjit_fnmadd_s(&vm->jit, rds, rs1, rs2, rs3), size)
#define rvjit_trace_fnmadd_d(rds, rs1, rs2, rs3, size)                                                                 \
    RVVM_RVJIT_TRACE_FPU(rvjit_fnmadd_d(&vm->jit, rds, rs1, rs2, rs3), size)
#define rvjit_trace_fnmsub_s(rds, rs1, rs2, rs3, size)                                                                 \
    RVVM_RVJIT_TRACE_FPU(rvjit_fnmsub_s(&vm->jit, rds, rs1, rs2, rs3), size)
#define rvjit_trace_fnmsub_d(rds, rs1, rs2, rs3, size)                                                                 \
    RVVM_RVJIT_TRACE_FPU(rvjit_fnmsub_d(&vm->jit, rds, rs1, rs2, rs3), size)
