...
#define RVVM_OPT_NONE         0x00
#define RVVM_OPT_RESET_PC     0x01 //!< Physical jump address at reset, defaults to 0x80000000
#define RVVM_OPT_DTB_ADDR     0x02 //!< Pass DTB address if non-zero, omits FDT generation
...
#define RVVM_OPT_JIT_CACHE    0x07 //!< Amount of per-core JIT cache (In bytes)
